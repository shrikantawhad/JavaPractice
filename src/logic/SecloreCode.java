...
public class SecloreCode
{
	...
	public static void main(String[] args) {
        ...
        Set<Integer> numbers2 = Set.of(1,2,3,4,5,7);
        Set<Integer> numbers3 = Set.of(1,2,3);
        Set<Integer> numbers4 = Set.of(4,5,6);
        Set<Integer> numbers5 = Set.of(2,4,6);
        Set<Integer> numbers6 = Set.of(2);
        ...
        List<Node> nodeList = List.of(node1, node2, node3, node4, node5, node6);
        ...
        for (Node node : nodeList) {
            System.out.println("Node with numbers: " + node.numbers);
...
public class HierarchicalGraphBuilder {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> numbers2 = Set.of(2, 3, 4);
        Set<Integer> numbers3 = Set.of(5, 6, 7);
        
        Node node1 = new Node(numbers1);
        Node node2 = new Node(numbers2);
        Node node3 = new Node(numbers3);

        List<Node> nodeList = List.of(node1, node2, node3);
